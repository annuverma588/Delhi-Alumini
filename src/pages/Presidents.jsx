...
const presidentsData = [
  { img: './President.png', num: '01', name: 'Mr. Atul Tripathi ', role: 'Founder & President (2007–2015)', bio: 'A visionary social worker from Delhi,Mr. Atul Tripathi founded Aangan Trust with three volunteers and one borrowed classroom. Under her leadership, the Trust expanded to 5 states and established its child protection model now adopted by 3 state governments.', stats: [{n: '8', l: 'Years Served'}, {n: '5', l: 'States Expanded'}, {n: '4K+', l: 'Lives Impacted'}] },
  { img: 'https://www.arcinstitute.in/Anil_sir.jpeg', num: '02', name: 'Anil Upadhyay', role: 'President (2015–2019)', bio: 'A retired IAS officer and child welfare champion, Shri Ramesh Nair brought institutional rigour and government partnerships to Aangan. He launched the Vidya Jyot digital classroom program and doubled the number of learning centres.', stats: [{n: '4', l: 'Years Served'}, {n: '30+', l: 'Classrooms Built'}, {n: '9K+', l: 'Lives Impacted'}] },
